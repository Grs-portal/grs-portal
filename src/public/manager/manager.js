      ...
      <div class="relative w-full h-[300px] bg-gray-200">
        ...
        <div class="p-6 space-y-6">
          ...
          <div class="grid grid-cols-6 gap-4 text-center">
            ...
            <div class="p-4 rounded-xl bg-emerald-700/70 backdrop-blur-md border border-white-200/30 shadow-sm hover:bg-emerald-/60 hover:scale-[1.02] transition-all duration-200">
